package com.ts8t;
     ...
     * market advantage for autonomous vehicles that use it. <p>
     * 
     * While choosing names for data, three objectives should guide us:<p>
     * 1. Choose clear/simple names that help avoid misunderstandings that cause bugs.<p>
     * 2. Choose names that make the code easier to read, by humans, our future selves. <p>
     * 3. Keep the names general enough so expected changes won't make them obsolete. <p>
     * 
     ...
     * language key words. The best names are also valued for their brevity. <p>
     * 
     * Starting with the simplest objects first:<p>
     *
     ...
     * that is the term used in geography and transportation science. <p>
     * 
     ...
     * and physics. But here, brevity and acceptance seem to outweigh the risk of future confusion.<p>
     * 
     ...
     * less ambiguity in the word distance. Vehicles travel a distance, not a length.<p>
     * 
     ...
     * vehicle movement.<p>
     * 
     * "Turn" is used here to name the action taken by a vehicle. It is both brief and clear.<p>
     * 
     ...
     * lanes are at the end of the link construct.<p>
     * 
     ...
     * link is a term used by transportation engineers and makers of transportation maps.<p>
     * 
     ...
     * route, origin and destination are the terms in active use by transportation engineers.<p>
     * 
